...
EVENTS_DB_NAME = '/databases/event_database.db'
VOLUNTEER_DB_NAME = '/databases/volunteer_database.db'
...
def create_app():
    ...
    app.config['SQLALCHEMY_BINDS'] = {
        'email_subcriptions' : f'sqlite://{EMAIL_SUBSCRIPTION_DB_NAME}', 
        'event_database' : f'sqlite://{EVENTS_DB_NAME}', 
        'volunteer_database' : f'sqlite://{VOLUNTEER_DB_NAME}'
        }
...
def create_dir():
    required_dirs = ['article_covers', 'writer_pfps', 'event_covers', 'volunteer_covers']
